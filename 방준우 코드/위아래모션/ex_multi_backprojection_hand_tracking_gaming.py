...
template_list.append(cv2.imread('template_2.png'))
template_list.append(cv2.imread('template_3.png'))
template_list.append(cv2.imread('template_4.png'))
template_list.append(cv2.imread('template_5.png'))
template_list.append(cv2.imread('template_6.png'))
#Open a webcam streaming
video_capture=cv2.VideoCapture(0) #Open the webcam
#Reduce the size of the frame to 320x240
video_capture.set(cv2.CAP_PROP_FRAME_WIDTH, 320)           #opencv 버전에 따라 cv2.cv.CV_CAP... 이 될수 있다
